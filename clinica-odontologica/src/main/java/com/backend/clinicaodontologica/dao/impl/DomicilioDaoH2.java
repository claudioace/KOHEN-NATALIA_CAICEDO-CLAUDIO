...
public class DomicilioDaoH2 implements IDao<Domicilio> {
    ...
    private final Logger LOGGER = LoggerFactory.getLogger(com.backend.clinicaodontologica.dao.impl.DomicilioDaoH2.class);
    ...
    public Domicilio actualizar(Domicilio domicilioModificado) {
        ...
        try {
            ...
            preparedStatement.setString(1, domicilioModificado.getCalle());
            preparedStatement.setInt(2, domicilioModificado.getNumero());
            preparedStatement.setString(3, domicilioModificado.getLocalidad());
            preparedStatement.setString(4, domicilioModificado.getProvincia());
            preparedStatement.execute();
